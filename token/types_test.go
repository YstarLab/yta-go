...
//			From:     AN("abourget"),
//			To:       AN("eosio"),
//			Quantity: yta.Asset{Amount: 123123, Symbol: yta.EOSSymbol},
//		},
//	}
//
//	buf, err := yta.MarshalBinary(a)
...
func TestUnpackActionTransfer(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			Transfer{AN("tbcox2.3"), AN("tbcox2"), yta.Asset{Amount: 9}, ""},
		},
		{
			"00000003884ed1c900000000884ed1c90900000000000000000000000000000004616c6c6f",
			Transfer{AN("tbcox2.3"), AN("tbcox2"), yta.Asset{Amount: 9}, "allo"},
		},
	}
	...
	for idx, test := range tests {
		...
		var res Transfer
		assert.NoError(t, yta.UnmarshalBinary(buf, &res), fmt.Sprintf("Index %d", idx))
