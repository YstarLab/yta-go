...
func TestABI_Read(t *testing.T) {
	...
	testCases := []map[string]interface{}{
		...
		{"caseName": "symbol", "typeName": "symbol", "value": `"4,YTA"`, "encode": EOSSymbol, "expectedError": nil, "isOptional": false, "isArray": false, "fieldName": "testedField"},
		...
		{"caseName": "asset", "typeName": "asset", "value": `"10.0000 YTA"`, "encode": Asset{Amount: 100000, Symbol: EOSSymbol}, "expectedError": nil, "isOptional": false, "isArray": false, "fieldName": "testedField"},
		{"caseName": "extended_asset", "typeName": "extended_asset", "value": "{\"asset\":\"0.0010 YTA\",\"Contract\":\"eoscanadacom\"}", "encode": ExtendedAsset{Asset: Asset{Amount: 10, Symbol: EOSSymbol}, Contract: "eoscanadacom"}, "expectedError": nil, "isOptional": false, "isArray": false, "fieldName": "testedField"},
...
func TestABI_Read_Symbol(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, `{"name":"4,YTA"}`, string(out))
}
